...
export const ROLE_PERMISSIONS = {
  ...
  INSTITUTION_ADMIN: [
    ...
    P.ATTENDANCE_CORRECT, P.VIEW_INSPECTIONS, P.VIEW_VIDEO_CHECK, P.VIEW_NOTIFICATIONS,
  ],
  INSTITUTION_STAFF: [
    P.VIEW_ATTENDANCE, P.MANAGE_BIOMETRIC_ENROLLMENT, P.ATTENDANCE_CORRECT, P.VIEW_NOTIFICATIONS,
  ],
