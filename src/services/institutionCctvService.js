...
const CCTV_READ = [PERMISSIONS.VIEW_CCTV, PERMISSIONS.VIEW_ASSIGNED_CCTV]
const HEALTH_READ = [PERMISSIONS.VIEW_ATTENDANCE, PERMISSIONS.VIEW_CCTV, PERMISSIONS.VIEW_ASSIGNED_CCTV]
